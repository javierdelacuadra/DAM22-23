...
public enum Pantallas {
    ...
    ADDCARPETASSCREEN(ConstantesPantallas.FXML_ADD_CARPETA_SCREEN_FXML), LISTCARPETASCOMPARTIDASSCREEN(ConstantesPantallas.FXML_LIST_CARPETAS_COMPARTIDAS_SCREEN_FXML);
