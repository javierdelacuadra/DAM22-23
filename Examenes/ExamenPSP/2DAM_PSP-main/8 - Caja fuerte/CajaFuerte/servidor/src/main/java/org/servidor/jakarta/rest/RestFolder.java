...
public class RestFolder {
    ...
    @GET
    public Folder getFolder(@QueryParam(AplicationConstants.USER_NAME) String userName, @QueryParam(AplicationConstants.NAME_FOLDER) String nameFolder, @QueryParam(AplicationConstants.PASSWORD) String password) {
        return folderServices.getFolder(userName, password, nameFolder);
    }
