...
public class FolderHibernate {
    ...
    public FolderHibernate(int id, String name, String password, boolean readOnly, List<MessageHibernate> toList) {
        this.id = id;
        this.name = name;
    ...
    public FolderHibernate(int id, String name, String password, boolean readOnly) {
        this.id = id;
        this.name = name;
        this.password = password;
        this.readOnly = readOnly;
