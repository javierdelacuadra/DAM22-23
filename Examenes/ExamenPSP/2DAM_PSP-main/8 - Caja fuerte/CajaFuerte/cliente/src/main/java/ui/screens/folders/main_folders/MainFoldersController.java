...
public class MainFoldersController extends BaseScreenController {
    ...
    private void stateListener() {
        ...
        if (newValue.getFolderSelected() != null) {
            txtNameUser.setText(getPrincipalController().getUserLoggedIn().getName());
    ...
    public void searchFolder() {
        viewModel.tryGetFolder(txtNameUser.getText(), txtNameFolder.getText(), pwdFolder.getText());
    }

    public void addFolder() {
        viewModel.addFolder(new Folder(txtNameFolder.getText(), pwdFolder.getText(), getPrincipalController().getUserLoggedIn().getName(), chkReadOnly.isSelected()));
    }
}
