    ...
    public int update(Suscription suscription) {
        try {
            ...
            if (suscription.getCancellation_date() == null) {
                ...
                return jtm.update(SQLQueries.UPDATE_SUBSCRIPTIONS_SET_CANCELLATION_DATE_WHERE_ID_READER_AND_ID_NEWSPAPER, suscription.getCancellation_date(), suscription.getId_reader(), suscription.getId_newspaper(), suscription.getSigning_date());
            }
    ...
    public int add(Suscription suscription) {
        ...
        try {
            ...
            if (message != null && message.contains(DAOConstants.SQL_INTEGRITY_CONSTRAINT_VIOLATION_EXCEPTION)) {
                throw new InvalidFieldsException(DAOConstants.THE_READER_NEWS_DONT_EXIST_OR_THE_READER_ALREADY_SUSCRIBED_TO_THIS_NEWSPAPER);
            } else {
