...
public class SQLQueries {
    ...
    public static final String DELETE_FROM_LOGIN_WHERE_ID_READER = "DELETE FROM login_oscar WHERE id_reader = ?";
    ...
    public static final String UPDATE_LOGIN_SET = "UPDATE login_oscar SET email = ? WHERE id_reader = ?";
