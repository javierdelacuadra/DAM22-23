...
public class UpdReaderViewModel {
    ...
    public void updateReader(String name, LocalDate birthDate) {
        ...
        if (current != null && current.getId() > 0) {
            ...
            Reader finalNewReader = new Reader(idCurrentReader, name, birthDate);
            setLoadingTrue();
    ...
    public void clearReader() {
        _state.setValue(new UpdReaderState(null, null, null, _state.get().getAllReaders(), false, null));
    }
}
