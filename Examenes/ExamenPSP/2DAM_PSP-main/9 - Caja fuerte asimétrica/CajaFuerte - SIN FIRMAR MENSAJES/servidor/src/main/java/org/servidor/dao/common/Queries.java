...
public class Queries {
    ...
    public static final String HQL_GET_MESSAGES_BY_FOLDER_ID = "HQL_GET_MESSAGES_BY_FOLDER_ID";
public static final String FROM_MESSAGE_HIBERNATE_M_WHERE_M_FOLDER_ID_FOLDER_ID = "FROM MessageHibernate m WHERE m.folder.id = :folderId";
