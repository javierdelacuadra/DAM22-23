...
public class MainMessagesController extends BaseScreenController {
    ...
    @FXML private MFXTableColumn<Message> issuerColumn;

    @FXML private MFXTextField txtUserToShareWith;
    @FXML
    ...
    public void principalCargado(){
        ...
        issuerColumn.setRowCellFactory(message -> new MFXTableRowCell<>(Message::getNameCreator));
        tblListener();
        stateListener();
        if (!folderLogged.isOwner()){
    ...
    public void addMessage() {
        viewModel.addMessage(txtMessage.getText(), getPrincipalController().getUserLoggedIn().getName());
    }

    public void updateMessage() {
        viewModel.updateMessage(txtMessage.getText(), getPrincipalController().getUserLoggedIn().getName());
    }
    ...
    public void shareFolder() {
        viewModel.shareFolder(getPrincipalController().getFolderSelected(), txtUserToShareWith.getText());
    }
}
