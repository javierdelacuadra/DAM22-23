...
public  class DataMapper {
    ...
    public MessageHibernate mensajeToMensajeHibernate(Message mensaje) {
        return new MessageHibernate(mensaje.getId(), mensaje.getMessageText(), mensaje.getMessageTextSigned());
    }
    private Message mensajeHibToMensaje(MessageHibernate messageHibernate) {
        return new Message(messageHibernate.getId(), messageHibernate.getMessage(), messageHibernate.getMessageFirmado(), messageHibernate.getFolder().getId(), messageHibernate.getUser().getName());
    }
