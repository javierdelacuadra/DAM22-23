...
public class SQLQueries {
    ...
    public static final String SELECT_ALL_READERS_WITH_LOGIN = "SELECT r.*, user, password FROM readers r INNER JOIN login l on r.id = l.id_reader WHERE r.id > 0 ORDER BY r.id";
