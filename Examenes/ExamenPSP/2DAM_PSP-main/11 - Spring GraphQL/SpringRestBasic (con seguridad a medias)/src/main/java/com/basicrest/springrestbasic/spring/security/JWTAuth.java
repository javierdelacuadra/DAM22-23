...
public class JWTAuth extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (header != null) {
            ...
            //Seguimos con la petición por si no requiere autenticación
    ...
    private void validarCredencialesBasic(HttpServletRequest request, HttpServletResponse response, FilterChain chain, String[] valores) throws IOException, ServletException {
        ...
        if (validatedUser.isRight()) {
            ...
            //Si las credenciales no son correctas devolvemos un error 401 y cortamos la petición
            response.setStatus(validatedUser.getLeft());
        }
    }
