        ...
        loginServicesImpl.loginInvitado().observeOn(Schedulers.single())
                .subscribe(responses ->
                {
                    if (responses.isRight()) {
                        _state.setValue(new LoginState(null, new Reader(CommonConstants.ID_INVITADO, AplicationConstants.INVITADO, LocalDate.of(1967, 11, 4), new Login(AplicationConstants.INVITADO, AplicationConstants.INVITADO)), null));
                    } else {
