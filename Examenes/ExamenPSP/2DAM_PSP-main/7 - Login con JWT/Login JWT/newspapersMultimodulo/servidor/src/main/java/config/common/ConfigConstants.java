...
public class ConfigConstants {
    ...
    public static final String PATH_SECURITY = "config/security.properties";
    public static final String FIXED_KEY = "fixedKey";
    public static final String REQUESTS_HOURS_TIMEOUT = "timeoutHours";
    public static final String REQUESTS_MINUTES_TIMEOUT = "timeoutMinutes";
    public static final String REQUESTS_SECONDS_TIMEOUT = "timeoutSeconds";

    public static final String MAX_READER_PETITIONS = "maxReaderPetitions";
