...
public class SQLQueries {
    ...
    public static final String GET_PETITION_STATUS_BY_EMAIL = "SELECT petitions_left, time_first_petition FROM login_oscar WHERE email = ?";
    public static final String UPDATE_PETITION_STATUS_BY_EMAIL = "UPDATE login_oscar SET petitions_left = ?, time_first_petition = ? WHERE email = ?";
