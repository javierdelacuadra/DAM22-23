...
public class NewspaperApiProducer {
    ...
    @Produces
    public RatonesAPI getRatonesApi(Retrofit retro) {
        return retro.create(RatonesAPI.class);
    }

    @Produces
    public InformesAPI getInformesApi(Retrofit retro) {
        return retro.create(InformesAPI.class);
    }
}